...
public class Controller {
    ...
    public Controller(){
        ...
        viewport = new FitViewport(ProjectX.V_WIDTH, ProjectX.V_HEIGHT, gameCam);
        stage = new Stage(viewport, ProjectX.batch);
        ...
        table.left().bottom();
        table.padLeft(30).padBottom(10);
        table.add(leftImg).size(leftImg.getWidth(), leftImg.getHeight());
        table.add().expandX().padLeft(20);
        table.add(rightImg).size(rightImg.getWidth(), rightImg.getHeight());
        table.add().expandX().padLeft(230);
